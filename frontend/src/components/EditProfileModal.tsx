            ...
            <div className="flex items-center justify-center sm:-mt-6">
              <label htmlFor="image" className="relative cursor-pointer ">
                {croppedImage || user.image ? (
                  ...
                  <div className="bg-gray-200 rounded-full img-preview object-cover w-20 h-20" />
                )}
            ...
            <div className="flex items-center justify-center sm:-mt-6">
              <div className="sm:w-[60%] w-full max-w-md">
                ...
                <div className="text-[11px] text-gray-500 mt-4">
                  name can only contain letters, numbers, underscores. Changing
                  your name will also change your profile link.
                </div>
              </div>
            </div>
          </div>
